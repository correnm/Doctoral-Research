...
CREATE TABLE `linkedin_known` (
  ...
  CONSTRAINT `linkedin_known_fk` FOREIGN KEY (`linkedin_pk`) REFERENCES `linkedin` (`linkedin_pk`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
-- Dump completed on 2015-04-11 19:15:20
