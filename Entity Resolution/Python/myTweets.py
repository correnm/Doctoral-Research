...
if __name__ == "__main__":
    if not OAUTH_TOKEN:
        ...
        oauth = get_oauth()
        r = requests.get(url="https://api.twitter.com/1.1/followers/list.json?cursor=-1&user_id=phonedude_mln&skip_status=true&include_user_entities=true ", auth=oauth)
        print r.json()
